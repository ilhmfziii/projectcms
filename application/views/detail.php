          ...
          <div class="col-lg-7">
            <div class="img-property-slide-wrap">
              <div class="img-property-slide">
                <img src="<?= base_url('assets/upload/konten/'.$konten->foto) ?>" alt="Image" class="img-fluid" />
              </div>
            </div>
          </div>
          <div class="col-lg-4">
            ...
            <div class="specs d-flex mb-4">
                <span class="d-block d-flex align-items-center me-3">
                    ...
                    <span class="caption"><?= $konten->nama; ?></span>
                </span>
                <span class="d-block d-flex align-items-center">
                    <span class="icon-folder me-2"></span>
                    <span class="caption"><?= $konten->nama_kategori; ?></span>
                </span>
            </div>
            ...
            <div class="d-block agent-box p-5">
              <div class="img mb-4">
                <img
                  src="<?= site_url('assets/sneat') ?>/assets/img/avatars/1.png"
                  alt="Image"
                  class="img-fluid"
                />
              </div>
              <div class="text">
                <h3 class="mb-0"><?= $konten->nama; ?></h3>
                <h1></h1>
